                ...
                <ul class="nav flex-column mt-5 w-100">
                    <li class="nav-item mb-4">
                        <a class="nav-link text-dark d-flex flex-column align-items-center text-center" href="#">
                            <img src="storage/pendaftaran.svg" alt="Pendaftaran" class="mb-2" style="width: 35px; height: 35px;">
                            <span style="color: #95A5A6; font-size: 13px">Pendaftaran</span>
                        </a>
                    </li>
                    <li class="nav-item mb-4">
                        <a class="nav-link text-dark d-flex flex-column align-items-center text-center" href="#">
                            <img src="storage/feedback.svg" alt="Feedback" class="mb-2" style="width: 35px; height: 35px;">
                            <span style="color: #95A5A6; font-size: 13px">Feedback</span>
                        </a>
                    </li>
                </ul>
            </nav>
