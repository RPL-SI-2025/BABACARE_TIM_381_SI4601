        ...
        <div class="col-span-1 bg-white shadow rounded-lg overflow-y-auto max-h-[600px]">
            <ul>
                @foreach ($notifications as $notif)
                    <li class="border-b">
                        <a href="{{ route('notifications.show', $notif->id) }}" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 {{ isset($notification) && $notif->id === $notification->id ? 'bg-blue-100 font-semibold' : '' }}">
