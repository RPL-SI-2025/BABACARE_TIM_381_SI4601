...
@section('header', 'Edit Resep Obat')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-semibold text-gray-800">Edit Resep Obat - {{ $prescription->prescription_code }}</h2>
        ...
        <form action="{{ route('prescriptions.update', $prescription) }}" method="POST" id="prescriptionForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <select dusk="patient_id" name="patient_id" id="patient_id" required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea dusk="drugs-allergies" name="drugs_allergies" id="drugs_allergies" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Masukkan informasi tentang alergi obat atau catatan khusus lainnya...">{{ old('drugs_allergies', $prescription->drugs_allergies) }}</textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const drugsAllergiesField = document.getElementById('drugs_allergies');
        ...
        // Trigger change event on page load if patient is already selected
